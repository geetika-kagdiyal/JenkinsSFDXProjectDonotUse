...
node {
    ...
    // -------------------------------------------------------------------------
 	...
 	withEnv(["HOME=${env.WORKSPACE}"]) {	
		...
		stage('Delta changes'){
		   //bat ' mkdir config'
		   bat 'sfdx sfpowerkit:project:diff --revisionfrom 2894903872541e752f277c3be74a5ec560ca4b31 --revisionto 5baec5ec4bb213ff615946d21ca108cd3c8ea965 --output config'
	    }
